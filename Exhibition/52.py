...
def getSrc(url):
    ...
    for item in soup.find_all('div',class_='show_info'):
...
def getData(baseurl):
    ...
    urllist = []
    # for i in range(1,5):
    urllist = getSrc("http://www.chinasilkmuseum.com/zz/list_17.aspx")
    # print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
