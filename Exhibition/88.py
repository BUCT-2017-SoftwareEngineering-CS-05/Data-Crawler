...
def getData(baseurl):
    ...
    urllist = []
    # for i in range(1,5):
    urllist = getSrc("http://www.gdmuseum.com/gdmuseum/_300730/_300734/index.html")
    # print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
