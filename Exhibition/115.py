...
def getSrc(url):
    ...
    for item in soup.find_all('div',class_='zhanlan-pic'):
        print(item)
...
def getData(baseurl):
    ...
    urllist = []
    # for i in range(1,5):
    urllist = getSrc("http://www.hylae.com/index.php?ac=article&at=list&tid=34")
    print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
