...
def getData(baseurl):
    datadict = {}
    for i in range (0,4):
        url = ["http://www.pgm.org.cn/pgm/yjj/201912/d6d3d69cc0ee43dc8a710e30c4892c6a.shtml","http://www.pgm.org.cn/pgm/zwh/201912/fdc6399960214c339091bbe7fa7bb4f8.shtml","http://www.pgm.org.cn/pgm/nksd/201912/292d25179fce4c8b8582fd955b96ee87.shtml","http://www.pgm.org.cn/pgm/hhyz/201912/58ad8054ac48469d8bc642a43d55bd54.shtml"]
        html = askUrl(url[i])
        ...
        #     print(item)
            ...
            intro = soup.find_all('div',class_="pages_content")[i]
