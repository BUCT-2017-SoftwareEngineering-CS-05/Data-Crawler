...
def getData(baseurl):
    datadict = {}
    for i in range (1000,1037):
        html = askUrl("http://www.sypm.org.cn/products_detail2/productId=%d.html"%i)
