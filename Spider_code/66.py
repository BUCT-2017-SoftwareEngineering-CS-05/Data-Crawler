...
def getSrc(url):
    ...
    for item in soup.find_all('div',class_='list_content'):
        # print(item)
...
def getData(baseurl):
    ...
    urllist = []
    # for i in range(1,5):
    urllist = getSrc("http://www.81-china.com/zhanlan/111.html")
    # print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
