...
def getSrc(url):
    urllist = []
    baseurl_ = 'http://www.81-china.com/'
    html = askUrl(url)
...
def getData(baseurl):
    datadict = {}
    urllist = ['http://www.qingdaomuseum.com/exhibition/detail/480','http://www.qingdaomuseum.com/exhibition/detail/464']
    # for i in ['480','464']:
    # urllist = getSrc("http://www.qingdaomuseum.com/exhibition/detail/%d"%i)
    # print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
