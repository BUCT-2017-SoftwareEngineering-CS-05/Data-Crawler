...
def getSrc(url):
    ...
    for item in soup.find_all('div',class_='active'):
        # print(item)
...
def getData(baseurl):
    ...
    urllist = []
    # for i in range(1,5):
    urllist = getSrc("http://www.wfsbwg.com/list/?52_1.html")
    # print(urllist)
    for url in urllist:
        # print(url)
        html = askUrl(url)
