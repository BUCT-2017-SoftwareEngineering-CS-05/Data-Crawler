...
def main():
    baseurl = "http://www.chnmuseum.cn/zl/zhanlanyugao/"
...
def getData(baseurl):
    ...
    datadict['midex'] = '11'
    i = 0
    for item in soup.find_all('div',class_="cj_zxx3"):
        # print(item)
        datadict['ename'] = str(item.text)
        print(datadict['ename'])
        intro = str(soup.find_all('div',class_="cj_zxx1")[i].text)
        intro = str(intro)+str(soup.find_all('div',class_="cj_zxx2")[i].text)
